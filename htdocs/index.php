...
/*
	...
	Open source application usage stats and report home system.

	(c) Copyright 2013 Jethro Carr
	http://projects.jethrocarr.com/p/oss-amberstats/
...
<html>
<head>
	<title>AmberStats</title>
	<meta name="copyright" content="(C)Copyright 2013 Jethro Carr">
	<link rel="shortcut icon" href="images/amberstats.ico" />
...
<!-- Header -->
<tr>
	<td bgcolor="#00c679" style="border: 1px #747474 dashed;">
		<table width="100%">
		<tr>
			<td width="50%" align="left"><img src="images/amberstats-logo.png" alt="AmberStats"></td>
...
<tr>
	...
	<tr>
		<td align="left">
		<p style="font-size: 10px; color: #ffffff;">AmberStats is licensed under the AGPL</p>
		</td>
