...
# for the AmberStats application.
#
...
my $db_name		= "amberstats";	# name of the DB to create
my $db_host		= "localhost";		# MySQL server

my $db_bs_user		= "amberstats";	# name of the aoconf user to create
my $db_bs_password	= random_password(10);	# random password to generate

# location of config.php file
my $opt_cfgfile = "/etc/amberstats/config.php";

# tmp file to use for SQL query generation
my $opt_tmpfile = "/tmp/amberstats_mysqlquery";
...
print "\n";
print "This script setups the AmberStats database components:\n";
print " * AmberStats MySQL user\n";
print " * AmberStats database\n";
print " * AmberStats configuration files\n";
print "\n";
print "THIS SCRIPT ONLY NEEDS TO BE RUN FOR THE VERY FIRST INSTALL OF AMBERSTATS.\n";
...
print "\n";
print "You can now login with the default username/password of setup/setup123 at http://localhost/amberstats\n";
print "\n";
