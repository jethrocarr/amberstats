...
#
# This script checks the current version of the database for the AmberStats application
...
if ($help)
{
	print "AmberStats Schema Management Utility\n";
	print "\n";
	print "Usage: schema_manage.pl --schemadir=<schemadir>\n";
	print "\n";
	print "-c, --cfgfile=FILENAME            AmberStats configuration file with MySQL settings.\n";
	print "\n";
